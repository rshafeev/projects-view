...
Ниже представлены ссылки на репозитории разрабатываемых проектов в период 2008-2014 гг. Практически в каждом проекте есть ссылка на демонстрационное видео(в readme файле в разделе "see demonstration video"), а также папка docs, в которой размещены, как правило, презентации и/или пояснительная документация.
